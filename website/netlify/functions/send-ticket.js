        ...
        <tr>
          <td class="content-td" style="padding:40px 38px 0 38px;background-color:#0d0d18;">
            ...
            <p style="margin:0 0 16px 0;font-size:15px;line-height:1.75;color:#b0b0cc;font-family:Arial,sans-serif;">
              We are truly privileged to have you join us at <strong style="color:#ffffff;">Elevate QA 2026</strong> — India's premier, invite-only Quality Engineering Tech Summit. Your expertise and presence will make this event extraordinary.
            </p>
