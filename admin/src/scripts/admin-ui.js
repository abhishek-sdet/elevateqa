...
// 1. Speakers
function addSpeakerItem(data = { name: '', role: '', img: '', status: '', title: '' }) {
  ...
  div.innerHTML = `
    ...
    <div class="form-grid-2">
      ...
      <div class="speaker-info-column">
        <div class="form-group"><label>Full Name</label><input type="text" class="s-name" value="${data.name || ''}" placeholder="e.g. Kapil Dev"></div>
